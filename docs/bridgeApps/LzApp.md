...
_Only admin can set the Layer Zero Endpoint address_
...
_Implemented by the real application_
...
_parameter for address is ignored as it is defaulted to the address of this contract_
...
_Only admin can set the send message version_
...
_Only admin can set the receive message version_
...
_Allow owner to set it multiple times._
...
_This action is destructive! Please use it only if you know what you are doing.
