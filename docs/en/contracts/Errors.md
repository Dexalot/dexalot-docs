...
AB-ZADDR-01: alot can not be address(0)

AB-ZBAL-01: no ALOT balance to burn
...
BV-ARLM-01: function signatures and targets array lengths do not match

BV-CDTS-01: calldata too short, a 4 byte function signature is required

BV-FSNW-01: function signature is not whitelisted

BV-IDNS-01: incentiveDistributor is not set, rewards leg is disabled

BV-IVTC-01: target is not a trusted contract

BV-SEAO-01: function signature already whitelisted against another target

BV-ZADDR-01: address can not be address(0)

BV-ZAMT-01: amount must be greater than 0

BV-ZCID-01: burnChainId can not be 0
...
FC-ARLM-01: symbols and prices array lengths do not match in setPrices

FC-BGMX-01: weeklyOpexBudget can not exceed MAX_WEEKLY_OPEX_BUDGET

FC-EPNC-01: no fully elapsed epoch left to close

FC-IVGN-01: genesis must not be in the future nor more than EPOCH_DURATION in the past

FC-STPR-01: prices are older than MAX_PRICE_AGE, refresh them before closing

FC-ZADDR-01: address can not be address(0)
...
VC-FDNS-01: fee token decimals not supported
...
VM-DTID-01: duplicate token ids not allowed
