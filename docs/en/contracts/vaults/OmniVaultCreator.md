...
| Name | Type |
| --- | --- |
| RISK_DISCLOSURE_TYPEHASH | bytes32 |
...
Private function to scale fee amount for non standard tokens

```solidity:no-line-numbers
function _scaleFee(uint256 _amount) private view returns (uint256 scaledAmount)
```
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| _amount | uint256 | The amount to FEE_AMOUNT_DECIMALS |

##### Return values

| Name | Type | Description |
| ---- | ---- | ----------- |
| scaledAmount | uint256 | The scaled amount for EVM transfer |
