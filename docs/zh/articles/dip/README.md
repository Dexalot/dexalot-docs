...
Dexalot是一家革命性的去中心化交易所，旨在通过去中心化的链上应用程序，带来传统中心化交易所的使用体验。它的使命是带来一个真正包容和透明的环境，让Dexalot的用户可以安全有效地交易数字资产，没有滑点或托管风险。它创建在区块链行业最快的智能合约平台Avalanche之上。

网站 | Twitter | Telegram | Medium |Discord
