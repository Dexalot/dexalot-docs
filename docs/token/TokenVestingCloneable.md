...
_sets the address for the portfolio._
...
_Transfers vested tokens to Portfolio._
...
_Allows the owner to revoke the vesting._
...
_Returns the amount for the amount remaining after the initial percentage vested at TGE._
...
_Returns the amount that has been released based on the initial percentage vested at TGE._
...
_Returns the amount that is releaseable based on the initial percentage vested  at TGE._
