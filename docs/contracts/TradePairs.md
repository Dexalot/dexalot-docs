...
DEPRECATED To send multiple Limit Orders in a single transaction designed specifically for Market Makers

**Dev notes:** \
DEPRECATED USE addOrderList instead. Will be removed in November 2024
